defmodule HogwartsApiWeb.AbsintheSocket do
  ...
  # pointing to the `HogwartsApiWeb.RoomChannel`:
  #
  # channel "room:*", HogwartsApiWeb.RoomChannel
  #
  ...
  #
  #     Elixir.HogwartsApiWeb.Endpoint.broadcast("user_socket:#{user.id}", "disconnect", %{})
  #
